# Auto generated from gists.yaml by pythongen.py version: 0.0.1
# Generation date: 2026-06-03T02:43:35
# Schema: gists
#
# id: https://w3id.org/lmodel/gists
# description: gist  is a minimalist upper ontology created by Semantic Arts for enterprise knowledge graph applications. This LinkML schema (version 14.1.0) aggregates the gist modules: Core (classes and properties), MediaTypes (IANA media type instances), and PrefixDeclarations (SHACL namespace bindings). Supplementary schemas gists_rdfs_annotations and gists_sub_class_assertions are available for annotation enrichment and OWL RL reasoner support.
# license: CC-BY-4.0
...
class TimeInterval(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.TimeInterval
...
class SchemaMetaData(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.SchemaMetaData
...
class PhysicalIdentifiableItem(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.PhysicalIdentifiableItem
...
class Category(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Category
...
class EquipmentType(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.EquipmentType
...
class Discipline(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Discipline
...
class GeneralMediaType(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GeneralMediaType
...
class Behavior(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Behavior
...
class Intention(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Intention
...
class GeoLocation(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GeoLocation
...
class GeoVolume(GeoLocation):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GeoVolume
...
class DegreeOfCommitment(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.DegreeOfCommitment
...
class Content(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Content
...
class ID(Content):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ID
...
class Address(Content):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Address
...
class PhysicalAddress(Address):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.PhysicalAddress
...
class Event(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Event
...
class ContemporaryEvent(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ContemporaryEvent
...
class PhysicalSubstance(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.PhysicalSubstance
...
class Commitment(Intention):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Commitment
...
class ContingentObligation(Commitment):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ContingentObligation
...
class UnitOfMeasure(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.UnitOfMeasure
...
class ProductCategory(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ProductCategory
...
class AddressUsageType(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.AddressUsageType
...
class GeoPoint(GeoLocation):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GeoPoint
...
class Composite(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Composite
...
class System(Composite):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.System
...
class Network(Composite):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Network
...
class Aspect(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Aspect
...
class ElectronicAddress(Address):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ElectronicAddress
...
class LivingThing(PhysicalIdentifiableItem):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.LivingThing
...
class Person(LivingThing):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Person
...
class PhysicalEvent(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.PhysicalEvent
...
class PhysicalAddressType(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.PhysicalAddressType
...
class GeoRegion(GeoLocation):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GeoRegion
...
class GovernedGeoRegion(GeoRegion):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GovernedGeoRegion
...
class CountryGeoRegion(GovernedGeoRegion):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.CountryGeoRegion
...
class IntellectualProperty(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.IntellectualProperty
...
class Equipment(PhysicalIdentifiableItem):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Equipment
...
class Function(Intention):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Function
...
class ContentExpression(Content):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ContentExpression
...
class Message(ContentExpression):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Message
...
class Agreement(Intention):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Agreement
...
class Component(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Component
...
class OrderedMember(Component):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.OrderedMember
...
class NetworkLink(Component):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.NetworkLink
...
class NetworkNode(Component):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.NetworkNode
...
class Task(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Task
...
class Contract(Agreement):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Contract
...
class Tag(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Tag
...
class Specification(Intention):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Specification
...
class CatalogItem(Specification):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.CatalogItem
...
class ContractTerm(Specification):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ContractTerm
...
class ServiceSpecification(CatalogItem):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ServiceSpecification
...
class EventSpecification(Specification):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.EventSpecification
...
class ProductSpecification(CatalogItem):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ProductSpecification
...
class Restriction(Intention):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Restriction
...
class KnowledgeConcept(IntellectualProperty):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.KnowledgeConcept
...
class ScheduledEvent(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ScheduledEvent
...
class Text(ContentExpression):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Text
...
class Organization(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Organization
...
class IntergovernmentalOrganization(Organization):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.IntergovernmentalOrganization
...
class GovernmentOrganization(Organization):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GovernmentOrganization
...
class CountryGovernment(GovernmentOrganization):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.CountryGovernment
...
class SubCountryGovernment(GovernmentOrganization):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.SubCountryGovernment
...
class Collection(Composite):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Collection
...
class UnitGroup(Collection):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.UnitGroup
...
class ControlledVocabulary(Collection):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ControlledVocabulary
...
class OrderedCollection(Collection):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.OrderedCollection
...
class Landmark(PhysicalIdentifiableItem):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Landmark
...
class Building(Landmark):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Building
...
class Language(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Language
...
class Project(Task):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Project
...
class MediaType(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.MediaType
...
class Transaction(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Transaction
...
class TemporalRelation(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.TemporalRelation
...
class Assignment(TemporalRelation):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Assignment
...
class Template(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Template
...
class TaskTemplate(Template):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.TaskTemplate
...
class FormattedContent(ContentExpression):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.FormattedContent
...
class RenderedContent(FormattedContent):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.RenderedContent
...
class Offer(ContingentObligation):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Offer
...
class Permission(Intention):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Permission
...
class Magnitude(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Magnitude
...
class ReferenceValue(Magnitude):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ReferenceValue
...
class BundledCatalogItem(CatalogItem):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.BundledCatalogItem
...
class PhysicalActionType(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.PhysicalActionType
...
class Account(Agreement):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Account
...
class Determination(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Determination
...
class ElectronicAddressType(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ElectronicAddressType
...
class HistoricalEvent(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.HistoricalEvent
...
class GeoRoute(OrderedCollection):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.GeoRoute
...
class ContingentEvent(Event):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ContingentEvent
...
class ScheduledTask(ScheduledEvent):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.ScheduledTask
...
class Requirement(Intention):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Requirement
...
class Medium(Category):
    ...
    class_model_uri: ClassVar[URIRef] = GISTS.Medium
...
class GistThing(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = GISTS["GistThing"]
    class_class_curie: ClassVar[str] = "gists:GistThing"
    class_name: ClassVar[str] = "GistThing"
    class_model_uri: ClassVar[URIRef] = GISTS.GistThing
...
slots.has_unique_navigational_parent = Slot(uri=GIST.hasUniqueNavigationalParent, name="has_unique_navigational_parent", curie=GIST.curie('hasUniqueNavigationalParent'),
                   model_uri=GISTS.has_unique_navigational_parent, domain=None, range=Optional[Union[str, list[str]]])

slots.is_assignment_to = Slot(uri=GIST.isAssignmentTo, name="is_assignment_to", curie=GIST.curie('isAssignmentTo'),
                   model_uri=GISTS.is_assignment_to, domain=None, range=Optional[Union[str, list[str]]])

slots.offers_to_provide = Slot(uri=GIST.offersToProvide, name="offers_to_provide", curie=GIST.curie('offersToProvide'),
                   model_uri=GISTS.offers_to_provide, domain=None, range=Optional[Union[str, list[str]]])

slots.provides_order_for = Slot(uri=GIST.providesOrderFor, name="provides_order_for", curie=GIST.curie('providesOrderFor'),
                   model_uri=GISTS.provides_order_for, domain=OrderedMember, range=Optional[Union[str, list[str]]])
...
slots.is_under_jurisdiction_of = Slot(uri=GIST.isUnderJurisdictionOf, name="is_under_jurisdiction_of", curie=GIST.curie('isUnderJurisdictionOf'),
                   model_uri=GISTS.is_under_jurisdiction_of, domain=None, range=Optional[Union[Union[dict, GovernmentOrganization], list[Union[dict, GovernmentOrganization]]]])

slots.requires = Slot(uri=GIST.requires, name="requires", curie=GIST.curie('requires'),
                   model_uri=GISTS.requires, domain=None, range=Optional[Union[str, list[str]]])

slots.is_governed_by = Slot(uri=GIST.isGovernedBy, name="is_governed_by", curie=GIST.curie('isGovernedBy'),
                   model_uri=GISTS.is_governed_by, domain=None, range=Optional[Union[str, list[str]]])

slots.links_to = Slot(uri=GIST.linksTo, name="links_to", curie=GIST.curie('linksTo'),
                   model_uri=GISTS.links_to, domain=None, range=Optional[Union[Union[dict, NetworkNode], list[Union[dict, NetworkNode]]]])

slots.is_about = Slot(uri=GIST.isAbout, name="is_about", curie=GIST.curie('isAbout'),
                   model_uri=GISTS.is_about, domain=Content, range=Optional[Union[str, list[str]]])

slots.prohibits = Slot(uri=GIST.prohibits, name="prohibits", curie=GIST.curie('prohibits'),
                   model_uri=GISTS.prohibits, domain=Intention, range=Optional[Union[Union[dict, Behavior], list[Union[dict, Behavior]]]])

slots.has_magnitude = Slot(uri=GIST.hasMagnitude, name="has_magnitude", curie=GIST.curie('hasMagnitude'),
                   model_uri=GISTS.has_magnitude, domain=None, range=Optional[Union[Union[dict, Magnitude], list[Union[dict, Magnitude]]]])

slots.has_unit_of_measure = Slot(uri=GIST.hasUnitOfMeasure, name="has_unit_of_measure", curie=GIST.curie('hasUnitOfMeasure'),
                   model_uri=GISTS.has_unit_of_measure, domain=Magnitude, range=Optional[Union[Union[dict, UnitOfMeasure], list[Union[dict, UnitOfMeasure]]]])

slots.has_participant = Slot(uri=GIST.hasParticipant, name="has_participant", curie=GIST.curie('hasParticipant'),
                   model_uri=GISTS.has_participant, domain=None, range=Optional[Union[str, list[str]]])

slots.is_geo_contained_in = Slot(uri=GIST.isGeoContainedIn, name="is_geo_contained_in", curie=GIST.curie('isGeoContainedIn'),
                   model_uri=GISTS.is_geo_contained_in, domain=GeoLocation, range=Optional[Union[Union[dict, "GeoLocation"], list[Union[dict, "GeoLocation"]]]])

slots.has_unique_broader = Slot(uri=GIST.hasUniqueBroader, name="has_unique_broader", curie=GIST.curie('hasUniqueBroader'),
                   model_uri=GISTS.has_unique_broader, domain=None, range=Optional[Union[str, list[str]]])

slots.is_allocated_by = Slot(uri=GIST.isAllocatedBy, name="is_allocated_by", curie=GIST.curie('isAllocatedBy'),
                   model_uri=GISTS.is_allocated_by, domain=None, range=Optional[Union[str, list[str]]])

slots.allows = Slot(uri=GIST.allows, name="allows", curie=GIST.curie('allows'),
                   model_uri=GISTS.allows, domain=None, range=Optional[Union[str, list[str]]])
...
slots.has_biological_parent = Slot(uri=GIST.hasBiologicalParent, name="has_biological_parent", curie=GIST.curie('hasBiologicalParent'),
                   model_uri=GISTS.has_biological_parent, domain=LivingThing, range=Optional[Union[Union[dict, "LivingThing"], list[Union[dict, "LivingThing"]]]])

slots.has_multiplier = Slot(uri=GIST.hasMultiplier, name="has_multiplier", curie=GIST.curie('hasMultiplier'),
                   model_uri=GISTS.has_multiplier, domain=None, range=Optional[Union[str, list[str]]])

slots.is_based_on = Slot(uri=GIST.isBasedOn, name="is_based_on", curie=GIST.curie('isBasedOn'),
                   model_uri=GISTS.is_based_on, domain=None, range=Optional[Union[str, list[str]]])

slots.has_address = Slot(uri=GIST.hasAddress, name="has_address", curie=GIST.curie('hasAddress'),
                   model_uri=GISTS.has_address, domain=None, range=Optional[Union[Union[dict, Address], list[Union[dict, Address]]]])
...
slots.has_physical_location = Slot(uri=GIST.hasPhysicalLocation, name="has_physical_location", curie=GIST.curie('hasPhysicalLocation'),
                   model_uri=GISTS.has_physical_location, domain=None, range=Optional[Union[Union[dict, GeoLocation], list[Union[dict, GeoLocation]]]])

slots.has_accuracy = Slot(uri=GIST.hasAccuracy, name="has_accuracy", curie=GIST.curie('hasAccuracy'),
                   model_uri=GISTS.has_accuracy, domain=None, range=Optional[Union[Union[dict, Magnitude], list[Union[dict, Magnitude]]]])

slots.conforms_to = Slot(uri=GIST.conformsTo, name="conforms_to", curie=GIST.curie('conformsTo'),
                   model_uri=GISTS.conforms_to, domain=None, range=Optional[Union[Union[dict, Intention], list[Union[dict, Intention]]]])

slots.sequence = Slot(uri=GIST.sequence, name="sequence", curie=GIST.curie('sequence'),
                   model_uri=GISTS.sequence, domain=None, range=Optional[int])

slots.planned_end_year = Slot(uri=GIST.plannedEndYear, name="planned_end_year", curie=GIST.curie('plannedEndYear'),
                   model_uri=GISTS.planned_end_year, domain=None, range=Optional[Union[str, XSDDateTime]])
...
slots.actual_start_microsecond = Slot(uri=GIST.actualStartMicrosecond, name="actual_start_microsecond", curie=GIST.curie('actualStartMicrosecond'),
                   model_uri=GISTS.actual_start_microsecond, domain=None, range=Optional[Union[str, XSDDateTime]])

slots.numeric_value = Slot(uri=GIST.numericValue, name="numeric_value", curie=GIST.curie('numericValue'),
                   model_uri=GISTS.numeric_value, domain=None, range=Optional[str])
...
slots.planned_end_date_time = Slot(uri=GIST.plannedEndDateTime, name="planned_end_date_time", curie=GIST.curie('plannedEndDateTime'),
                   model_uri=GISTS.planned_end_date_time, domain=None, range=Optional[Union[str, XSDDateTime]])
...
slots.exponent_of_us_dollar = Slot(uri=GIST.exponentOfUSDollar, name="exponent_of_us_dollar", curie=GIST.curie('exponentOfUSDollar'),
                   model_uri=GISTS.exponent_of_us_dollar, domain=UnitGroup, range=Optional[Decimal])
...
slots.planned_start_minute = Slot(uri=GIST.plannedStartMinute, name="planned_start_minute", curie=GIST.curie('plannedStartMinute'),
                   model_uri=GISTS.planned_start_minute, domain=None, range=Optional[Union[str, XSDDateTime]])

slots.at_date_time = Slot(uri=GIST.atDateTime, name="at_date_time", curie=GIST.curie('atDateTime'),
                   model_uri=GISTS.at_date_time, domain=None, range=Optional[Union[str, XSDDateTime]])
...
slots.planned_start_date_time = Slot(uri=GIST.plannedStartDateTime, name="planned_start_date_time", curie=GIST.curie('plannedStartDateTime'),
                   model_uri=GISTS.planned_start_date_time, domain=None, range=Optional[Union[str, XSDDateTime]])

slots.conversion_factor = Slot(uri=GIST.conversionFactor, name="conversion_factor", curie=GIST.curie('conversionFactor'),
                   model_uri=GISTS.conversion_factor, domain=UnitOfMeasure, range=Optional[str])

slots.exponent_of_radian = Slot(uri=GIST.exponentOfRadian, name="exponent_of_radian", curie=GIST.curie('exponentOfRadian'),
                   model_uri=GISTS.exponent_of_radian, domain=UnitGroup, range=Optional[Decimal])
